(deftheme deserted
  "inspired by vim's desert theme")

(custom-theme-set-faces
 'deserted
 '(default ((t (:family "Ubuntu Sans Mono" :foundry "DAMA" :width normal :height 203 :weight regular :slant normal :underline nil :overline nil :extend nil :strike-through nil :box nil :inverse-video nil :foreground "white" :background "gray23" :stipple nil :inherit nil))))
 ...
 '(whitespace-big-indent ((((class color) (min-colors 88) (background dark)) (:foreground "red"))))
 '(whitespace-empty ((((class color) (min-colors 88) (background dark)) (:foreground "yellow"))))
 '(whitespace-indentation ((((class color) (min-colors 88) (background dark)) (:foreground "red"))))
 '(whitespace-line ((((class color) (min-colors 88) (background dark)) (:foreground "violet"))))
 '(whitespace-newline ((((class color) (min-colors 88) (background dark)) (:foreground "darkgray"))))
 '(whitespace-space ((((class color) (min-colors 88) (background dark)) (:foreground "darkgray"))))
 '(whitespace-missing-newline-at-eof ((((class color) (min-colors 88) (background dark)) (:foreground "#d0d040"))))
 '(whitespace-space-after-tab ((((class color) (min-colors 88) (background dark)) (:foreground "yellow"))))
 '(whitespace-space-before-tab ((((class color) (min-colors 88) (background dark)) (:foreground "yellow"))))
 '(whitespace-tab ((((class color) (min-colors 88) (background dark)) (:foreground "darkgray"))))
 '(font-lock-bracket-face ((t (:inherit (font-lock-punctuation-face)))))
 '(font-lock-builtin-face ((((class grayscale) (background light)) (:weight bold :foreground "LightGray")) (((class grayscale) (background dark)) (:weight bold :foreground "DimGray")) (((class color) (min-colors 88) (background light)) (:foreground "dark slate blue")) (((class color) (min-colors 88) (background dark)) (:foreground "IndianRed")) (((class color) (min-colors 16) (background light)) (:foreground "Orchid")) (((class color) (min-colors 16) (background dark)) (:foreground "LightSteelBlue")) (((class color) (min-colors 8)) (:weight bold :foreground "blue")) (t (:weight bold))))
 '(font-lock-comment-delimiter-face ((default (:inherit (font-lock-comment-face)))))
 '(font-lock-comment-face ((((class grayscale) (background light)) (:slant italic :weight bold :foreground "DimGray")) (((class grayscale) (background dark)) (:slant italic :weight bold :foreground "LightGray")) (((class color) (min-colors 88) (background light)) (:foreground "Firebrick")) (((class color) (min-colors 88) (background dark)) (:foreground "#5fd7ff")) (((class color) (min-colors 16) (background light)) (:foreground "red")) (((class color) (min-colors 16) (background dark)) (:foreground "red1")) (((class color) (min-colors 8) (background light)) (:foreground "red")) (((class color) (min-colors 8) (background dark)) (:foreground "yellow")) (t (:slant italic :weight bold))))
 ...
 '(line-number-current-line ((((class color) (min-colors 88) (background dark)) (:weight bold :foreground "DarkViolet")))))

(provide-theme 'deserted)
