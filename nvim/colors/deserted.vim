" Name:         deserted
" Description:  Colorscheme inspired by Hans Fugal's desert.
" Author:       Original author Emilio Izaguirre <emilioizaguirre@uchicago.edu>
" Maintainer:   Original maintainer Emilio Izaguirre <emilioizaguirre@uchicago.edu>
" Website:      https://github.com/emilioizaguirre/deserted
" License:      Same as Vim
...
hi StatusLineTermNC guifg=#ffffff guibg=#afaf87 gui=NONE cterm=NONE
hi VertSplit guifg=#7f7f8c guibg=#afaf87 gui=NONE cterm=NONE
...
hi WildMenu guifg=#303030 guibg=#ffff87 gui=NONE cterm=NONE
...
hi Statement guifg=#5faf87 guibg=NONE gui=NONE cterm=NONE
